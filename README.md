...
| [Compute_PQ_metric](https://github.com/ruchikaverma-iitg/MoNuSAC/blob/master/Panoptic%20Quality.ipynb) | Compute Panoptic Quality metric for each image stored as n-ary masks|
